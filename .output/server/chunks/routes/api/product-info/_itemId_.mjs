...
const _itemId_ = defineEventHandler(async (event) => {
  ...
  try {
    const res = await axios.get(`https://gudangdata.crunchymediadigital.id/api/v1/gudangdata/${itemId}`, {
      headers: {
        ...
        "Referer": `https://gudangdata.crunchymediadigital.id/api/v1/gudangdata/${itemId}`,
